...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'div', 'nav', 'a']]
};
...
const cssTestCase2 = {
    testCaseName: 'CSS nav a Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
...
const cssTestCase3 = {
    testCaseName: 'CSS dropdown Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
...
const cssTestCase4 = {
    testCaseName: 'CSS dropdown-content Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
